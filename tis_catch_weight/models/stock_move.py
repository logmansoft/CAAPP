...
class StockMoveCWUOM(models.Model):
    ...
    cw_unit_factor = fields.Float('CW Unit Factor')


    #cw_qty_to_consume = fields.Float(string='CW To Consume')
    cw_qty_reserved = fields.Float(string='CW Reserved')
    cw_qty_consumed = fields.Float(string='CW Consumed')
    #cw_qty_done = fields.Float(string='CW Done', compute='_cw_quantity_done_compute', inverse='_cw_quantity_done_compute')
    ...
    def _cw_quantity_done_compute(self):
        ...
        for move in self:
            for move_line in move.move_line_ids:
                move.cw_qty_done += move_line.product_cw_uom._compute_quantity(move_line.cw_qty_done, move_line.product_cw_uom)
